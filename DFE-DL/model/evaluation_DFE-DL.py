...
with open('**/params_DFE-DL_evaluation') as f: # args[1] should contain path to params.json file
    params = json.load(f)

# set random seed for creating the testing set first
full_dataframe = pd.read_pickle('**/new_RE.pkl')        # this can be a .pkl involving 3D conformers
...
#test_dataframe = pd.read_pickle('**/outtest.pkl')  ## this can be set as an external test set
